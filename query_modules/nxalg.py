...
def node_connectivity(
    ctx: mgp.ProcCtx, source: mgp.Nullable[mgp.Vertex] = None, target: mgp.Nullable[mgp.Vertex] = None
...
@mgp.read_proc
def node_boundary(
    ctx: mgp.ProcCtx, nbunch1: mgp.List[mgp.Vertex], nbunch2: mgp.Nullable[mgp.List[mgp.Vertex]] = None
...
def betweenness_centrality(
    ...
    return [
        ...
        for n, b in nx.betweenness_centrality(
            MemgraphDiGraph(ctx=ctx), k=k, normalized=normalized, weight=weight, endpoints=endpoints, seed=seed
        ).items()
    ]
...
@mgp.read_proc
def find_cliques(ctx: mgp.ProcCtx) -> mgp.Record(cliques=mgp.List[mgp.List[mgp.Vertex]]):
...
@mgp.read_proc
def clustering(
    ctx: mgp.ProcCtx, nodes: mgp.Nullable[mgp.List[mgp.Vertex]] = None, weight: mgp.Nullable[str] = None
...
@mgp.read_proc
def communicability(ctx: mgp.ProcCtx) -> mgp.Record(node1=mgp.Vertex, node2=mgp.Vertex, communicability=mgp.Number):
    return [
...
def k_clique_communities(
    ctx: mgp.ProcCtx, k: int, cliques: mgp.Nullable[mgp.List[mgp.List[mgp.Vertex]]] = None
...
@mgp.read_proc
def biconnected_components(ctx: mgp.ProcCtx) -> mgp.Record(components=mgp.List[mgp.List[mgp.Vertex]]):
...
@mgp.read_proc
def strongly_connected_components(ctx: mgp.ProcCtx) -> mgp.Record(components=mgp.List[mgp.List[mgp.Vertex]]):
...
@mgp.read_proc
def find_cycle(
    ctx: mgp.ProcCtx, source: mgp.Nullable[mgp.List[mgp.Vertex]] = None, orientation: mgp.Nullable[str] = None
...
# data.
@mgp.read_proc
def simple_cycles(ctx: mgp.ProcCtx) -> mgp.Record(cycles=mgp.List[mgp.List[mgp.Vertex]]):
...
@mgp.read_proc
def topological_sort(ctx: mgp.ProcCtx) -> mgp.Record(nodes=mgp.Nullable[mgp.List[mgp.Vertex]]):
...
def shortest_path(
    ...
    sp = nx.shortest_path(MemgraphMultiDiGraph(ctx=ctx), source=source, target=target, weight=weight, method=method)
...
def shortest_path_length(
    ...
    sp = nx.shortest_path_length(
        MemgraphMultiDiGraph(ctx=ctx), source=source, target=target, weight=weight, method=method
    )
...
def all_shortest_paths(
    ctx: mgp.ProcCtx, source: mgp.Vertex, target: mgp.Vertex, weight: mgp.Nullable[str] = None, method: str = "dijkstra"
...
def multi_source_dijkstra_path(
    ctx: mgp.ProcCtx, sources: mgp.List[mgp.Vertex], cutoff: mgp.Nullable[int] = None, weight: str = "weight"
...
def all_simple_paths(
    ctx: mgp.ProcCtx, source: mgp.Vertex, target: mgp.Vertex, cutoff: mgp.Nullable[int] = None
) -> mgp.Record(paths=mgp.List[mgp.List[mgp.Vertex]]):
...
@mgp.read_proc
def bfs_edges(
    ctx: mgp.ProcCtx, source: mgp.Vertex, reverse: bool = False, depth_limit: mgp.Nullable[int] = None
) -> mgp.Record(edges=mgp.List[mgp.Edge]):
    return mgp.Record(
        edges=list(nx.bfs_edges(MemgraphMultiDiGraph(ctx=ctx), source, reverse=reverse, depth_limit=depth_limit))
    )
...
def bfs_tree(
    ...
    return mgp.Record(
        tree=list(nx.bfs_tree(MemgraphMultiDiGraph(ctx=ctx), source, reverse=reverse, depth_limit=depth_limit))
    )
...
@mgp.read_proc
def edge_bfs(
    ctx: mgp.ProcCtx, source: mgp.Nullable[mgp.Vertex] = None, orientation: mgp.Nullable[str] = None
) -> mgp.Record(edges=mgp.List[mgp.Edge]):
    return mgp.Record(
...
def minimum_spanning_tree(
    ctx: mgp.ProcCtx, weight: str = "weight", algorithm: str = "kruskal", ignore_nan: bool = False
