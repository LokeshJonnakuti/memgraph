...
def main():
    ...
    parser.add_argument(
        "-allow-enabling-alpha-checkers", action="store_true", help="allow alpha checkers from " "clang-analyzer."
    )
    parser.add_argument("-clang-tidy-binary", metavar="PATH", default="clang-tidy-11", help="path to clang-tidy binary")
    parser.add_argument(
